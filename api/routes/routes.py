...
from api.meterValues.meter_values_services import router as meter_values_services
routers = APIRouter()
...
routers.include_router(meter_values_services, prefix="/meter_values", tags=["meter values"])